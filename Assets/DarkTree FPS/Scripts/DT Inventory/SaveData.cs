...
namespace DTInventory
{
    public class SaveData : MonoBehaviour
    {
        ...
        public void Save()
        {
            ...
            PlayerStatsData p_data = new PlayerStatsData(stat.health, stat.useConsumeSystem, stat.playerPosition, stat.playerRotation, camera_rot, controller.targetDirection, controller._mouseAbsolute, controller._smoothMouse);
    ...
    public class PlayerStatsData
    {
        ...
        public PlayerStatsData(int health, bool useConsumeSystem, Vector3 playerPosition, Quaternion playerRotation, Quaternion camRotation, Vector2 targetDirection, Vector2 mouseAbsolute, Vector2 smoothMouse)
        {
            this.health = health;
